  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        console.log("filterId",typeof(newFilterId));
        setFilterName('');
        ...
        try {
          const filId =  Array.isArray(newFilterId) ? newFilterId : [newFilterId]
          const startPayload = {
            filter_id: filId ,
          ...
          const startResponse = await axios.post('http://5.180.148.40:9006/api/osint-man/v1/start', startPayload, {
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`,
            },
    ...
    <>
      <form>
        ...
        <div
          ...
          ref={containerRef}
          style={{ maxHeight: '300px', overflowY: 'auto', marginTop: '5px', padding:'0px'}}
        >
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <Dropdown className="w-100 keywords-dropdown" id={`${source.platform}-keywords-${index}`}>
                      ...
                      <Dropdown.Menu className="w-100  keywords-dropdown-menu" style={{ maxHeight: '300px', overflowY: 'auto' }}>
