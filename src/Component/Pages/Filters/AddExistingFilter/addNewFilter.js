...
//   const newFilterId = filterId[filterId.length - 1]; // Assuming the last filter ID is the one we want to use
//   if (newFilterId) {
//     try {
//       const startPayload = {
...
//     }
//   } else {
//     toast.error('No filter ID available to start the task.');
//   }
// };
...
//               Add 
//             </button>
//             <button type="button" className="btn btn-secondary add-new-filter-button" style={{ marginLeft: '5px' }} onClick={handleSaveFilter}>
//             Save Filter
//             </button>
//             <button type="button" className="btn btn-primary add-new-filter-button" style={{ marginLeft: '5px' }} onClick={handleProceed}>
//               Proceed
//             </button>
//           </div>
//         </div>
...
const AddNewFilter = ({ onNewFilterCreated }) => {
  const [platform, setPlatform] = useState([]);
  const [newKeyword, setNewKeyword] = useState('');
  const [filterName, setFilterName] = useState('');
  const [description, setDescription] = useState('');
